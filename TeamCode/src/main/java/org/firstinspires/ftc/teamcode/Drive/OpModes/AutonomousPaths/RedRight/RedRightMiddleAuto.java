...
@Autonomous
public class RedRightMiddleAuto extends OpMode {
    ...
    public void init_loop() {
        telemetry.addData("Successful: ", "Ready for RedRight - Middle - (Backdrop Side)");
    ...
    public void start() {
        ...
        TrajectorySequence backdropMiddle = robot.driveSubsystem.trajectorySequenceBuilder(new Pose2d(17.85, -65.56, Math.toRadians(90.00)))
                .splineTo(
                        new Vector2d(49.36, -36.83), Math.toRadians(0.00),
        ...
        TrajectorySequence tapeMiddle = robot.driveSubsystem.trajectorySequenceBuilder(backdropMiddle.end())
                .lineToSplineHeading(
                        new Pose2d(27.25, -24.81, Math.toRadians(0.00)),
                        SampleMecanumDrive.getVelocityConstraint(35, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                )
                .build();
