...
public class ClawSubsystem extends SubsystemBase {
    ...
    public static double releasePositionLeft = 1, releasePositionRight = 0, smallReleasePositionLeft = 0.65, smallReleasePositionRight = 0.400;
    ...
    public void customLeft(double pos) {
        clawLeft.setPosition(pos);
    }

    public void customRight(double pos) {
