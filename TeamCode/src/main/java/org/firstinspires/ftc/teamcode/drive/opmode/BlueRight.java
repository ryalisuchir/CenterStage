...
public class BlueRight extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            ...
            //1=middle
            //2=left
            TrajectorySequence untitled0 = drive.trajectorySequenceBuilder(new Pose2d(19.32, -67.43, Math.toRadians(90.00)))
                    .lineToConstantHeading(new Vector2d(61.46, -55.84))
                    .lineToConstantHeading(new Vector2d(64.45, -61.81))
                    .build();
