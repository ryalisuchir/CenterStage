...
public class BlueLeftProcessor implements VisionProcessor, CameraStreamSource {
     ...
     */
    public BlueLeftProcessor(@NonNull Scalar lower, @NonNull Scalar upper, DoubleSupplier minArea, DoubleSupplier left, DoubleSupplier right) {
    ...
    public Object processFrame(Mat frame, long captureTimeNanos) {
        ...
        } else if (largestContourArea < 2000) {
