package org.firstinspires.ftc.teamcode.Drive.LeagueRewrites.BasicAutonomous;
...
public class BlueLeft extends OpMode {
    ...
    public void init() {
        ...
        telemetry.addData("Not Ready: ", "Not able to proceed to camera detection...");
        telemetry.update();
    ...
    public void start() {
        ...
        robot.driveSubsystem.setPoseEstimate(new Pose2d(15.76, 63.47, Math.toRadians(270.00)));
        ...
        switch (recordedPropPosition) {
            ...
            case UNFOUND:
                ...
                TrajectorySequence movement3Left = robot.driveSubsystem.trajectorySequenceBuilder(movement2Left.end())
                        .splineToConstantHeading(new Vector2d(35.96, 36.65), Math.toRadians(0.00))
                        .splineToConstantHeading(new Vector2d(56.15, 61.55), Math.toRadians(0.00))
                        .build();
