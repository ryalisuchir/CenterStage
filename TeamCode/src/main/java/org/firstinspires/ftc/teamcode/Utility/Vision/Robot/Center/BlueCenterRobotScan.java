package org.firstinspires.ftc.teamcode.Utility.Vision.Robot.Center;
...
public class BlueCenterRobotScan implements VisionProcessor, CameraStreamSource {
    ...
    private double senseThreshold = 0.032;
    Telemetry telemetry;
    ...
    public void init(int width, int height, CameraCalibration calibration) {
        ...
        this.SENSED_RECTANGLE = new Rect(
                new Point(0.08*width, 0.56 * height),
                new Point(0.86 * width, 0.65 * height)
        );
