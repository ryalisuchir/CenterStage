...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 10.2086; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 7.5; // in; offset of the lateral wheel

    private Encoder leftEncoder, rightEncoder, frontEncoder;
    public static double X_MULTIPLIER = 1.0304989; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1.0064159; // Multiplier in the Y direction
