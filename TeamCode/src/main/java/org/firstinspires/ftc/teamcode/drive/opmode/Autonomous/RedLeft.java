...
//        USE_WEBCAM = true;
//        initTfod();
//        telemetry.addData("D.S. Preview: ", "Ready for RedLeft (NOT Backdrop Side)");
//        telemetry.update();
//
//        robot.a.armIntake();
//        robot.claw.grabBoth();
...
//            TrajectorySequence firstGeneralRight = drive.trajectorySequenceBuilder(new Pose2d(-32.13, -64.86, Math.toRadians(-90.00)))
//                    .lineToConstantHeading(new Vector2d(-39.09, -64.51))
//                    .build();
//
//            TrajectorySequence dropPixelRight = drive.trajectorySequenceBuilder(firstGeneralRight.end())
//                    .lineToSplineHeading(new Pose2d(-33.52, -31.95, Math.toRadians(0.00)))
//                    .build();
//
//            TrajectorySequence backdropPixelRight = drive.trajectorySequenceBuilder(dropPixelRight.end())
//                    .lineToConstantHeading(new Vector2d(-57.03, -37.70))
//                    .build();
//
//            TrajectorySequence preParkRight = drive.trajectorySequenceBuilder(backdropPixelRight.end())
//                    .lineToConstantHeading(new Vector2d(-57.37, -11.23))
//                    .build();
//
//            TrajectorySequence parkRight = drive.trajectorySequenceBuilder(preParkRight.end())
//                    .lineToConstantHeading(new Vector2d(65.04, -10.01))
//                    .build();
//
...
//            TrajectorySequence firstGeneralLeft = drive.trajectorySequenceBuilder(new Pose2d(-32.13, -64.86, Math.toRadians(-90.00)))
//                    .lineToConstantHeading(new Vector2d(-38.22, -64.16))
//                    .build();
//
//            TrajectorySequence dropPixelLeft = drive.trajectorySequenceBuilder(firstGeneralLeft.end())
//                    .lineToConstantHeading(new Vector2d(-47.97, -43.10))
//                    .build();
//
