...
public class ANewBlueProcessor implements VisionProcessor, CameraStreamSource {
    ...
    public ANewBlueProcessor(@NonNull Scalar lower, @NonNull Scalar upper, DoubleSupplier minArea, DoubleSupplier left, DoubleSupplier right) {
