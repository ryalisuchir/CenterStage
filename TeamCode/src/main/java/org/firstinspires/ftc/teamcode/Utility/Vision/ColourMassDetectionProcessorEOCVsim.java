...
public class ColourMassDetectionProcessorEOCVsim implements VisionProcessor {
    ...
    public Scalar upper; // lower bounds for masking
    public Scalar lower; // upper bounds for masking
    ...
    public ColourMassDetectionProcessorEOCVsim() {
        ...
        this.lower = new Scalar(110, 160, 90); // the lower hsv threshold for your detection
        this.upper = new Scalar(121.8, 200, 255); // the upper hsv threshold for your detection
        this.minArea = () -> 100;
